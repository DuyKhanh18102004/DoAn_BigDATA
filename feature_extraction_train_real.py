#!/usr/bin/env python3
"""
Feature Extraction - TRAIN REAL ONLY (50,000 images)
Batch 1/4 of full pipeline
"""
...
print("=" * 80)
print("🚀 BATCH 1/4: TRAIN REAL Feature Extraction")
print("=" * 80)

# Initialize Spark
spark = SparkSession.builder \
    .appName("FeatureExtraction-TrainREAL-Batch1") \
    .getOrCreate()
...
print("\n📂 Loading TRAIN REAL images from HDFS...")
...
count_real = train_real_df.count()
print(f"✅ Train REAL: {count_real} images")

print("\n🔬 Extracting features using ResNet50 UDF...")
features_real = train_real_df.withColumn(
    "features_label",
    extract_features_udf(col("content"), col("label_str"))
).select("path", "features_label")

print("\n💾 Saving features to HDFS...")
output_path = "hdfs://namenode:8020/user/data/features/train/REAL"
features_real.write.mode("overwrite").parquet(output_path)

print(f"\n✅ BATCH 1/4 COMPLETED!")
print(f"✅ Output: {output_path}")
print(f"✅ Processed: {count_real} images")
print("=" * 80)
