#!/usr/bin/env python3
"""
Feature Extraction - TEST REAL ONLY (10,000 images)
Batch 3/4 of full pipeline
"""
...
print("=" * 80)
print("🚀 BATCH 3/4: TEST REAL Feature Extraction")
print("=" * 80)

# Initialize Spark
spark = SparkSession.builder \
    .appName("FeatureExtraction-TestREAL-Batch3") \
    .getOrCreate()
...
print("\n📂 Loading TEST REAL images from HDFS...")
...
count_real = test_real_df.count()
print(f"✅ Test REAL: {count_real} images")

print("\n🔬 Extracting features using ResNet50 UDF...")
features_real = test_real_df.withColumn(
    "features_label",
    extract_features_udf(col("content"), col("label_str"))
).select("path", "features_label")

print("\n💾 Saving features to HDFS...")
output_path = "hdfs://namenode:8020/user/data/features/test/REAL"
