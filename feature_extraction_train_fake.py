#!/usr/bin/env python3
"""
Feature Extraction - TRAIN FAKE ONLY (50,000 images)
Batch 2/4 of full pipeline
"""
...
print("=" * 80)
print("🚀 BATCH 2/4: TRAIN FAKE Feature Extraction")
print("=" * 80)

# Initialize Spark
spark = SparkSession.builder \
    .appName("FeatureExtraction-TrainFAKE-Batch2") \
    .getOrCreate()
...
print("\n📂 Loading TRAIN FAKE images from HDFS...")
...
count_fake = train_fake_df.count()
print(f"✅ Train FAKE: {count_fake} images")

print("\n🔬 Extracting features using ResNet50 UDF...")
features_fake = train_fake_df.withColumn(
    "features_label",
    extract_features_udf(col("content"), col("label_str"))
).select("path", "features_label")

print("\n💾 Saving features to HDFS...")
output_path = "hdfs://namenode:8020/user/data/features/train/FAKE"
